    ...
    return (
        ...
        >
            ...
            <FramerImage
                ...
                src={img} ref={imgRef} alt={title} className="z-10 w-96 h-auto hidden absolute rounded-lg md:!hidden" />
        </Link>
    )
}
...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
    ...
    return (
        <li className="col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl relative dark:bg-dark dark:border-light">
            ...
            rounded-br-3xl dark:bg-light dark:border-light
            ' />
            <Link
                href={link}
                target="_blank"
        ...
        <>
            ...
            <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light">
                <Layout className="pt-16">
                    ...
                    <ul className="grid grid-cols-2 gap-16 md:gap-y-16 md:grid-cols-1 lg:gap-8">
