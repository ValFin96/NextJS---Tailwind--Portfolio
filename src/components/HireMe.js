...
<Link href="mailto:valeria.finogeeva@gmail.com" className="flex items-center justify-center 
...
dark:bg-light dark:text-dark dark:hover:bg-dark dark:hover:text-light dark:hover:border-light md:w-12 md:h-12 md:text-[10px]
"> 
Hire Me
</Link>
</div>
