...
import { TwitterIcon, DribbleIcon, GithubIcon, LinkedInIcon, PinterestIcon } from "./Icons";
...
const CustomLink = ({ href, title, className = "" }) => {
    ...
    return (
        <Link href={href} className={`${className} relative group`}>
            {title}
            {/* give the navbar links an underline with a transition */}
    ...
    return (
        ...
        ">
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                ...
                <nav className="flex itens-center justify-center flex-wrap ">
            ...
            ">
                        ...
                        <nav className="flex itens-center justify-center flex-wrap mt-2">
                            <motion.a href="https://twitter.com" target={"_blank"}
                                whileHover={{ y: -2 }}
                                whileTap={{ scale: 0.9 }}
